...
sys.path.append("/workspaces/Machine-Learning/Nystromformer/my_nys")

try:
    from model import build_nystromformer
    print("Successfully imported build_nystromformer")
    ...
    model = build_nystromformer(
        src_vocab_size, tgt_vocab_size, src_seq_len, tgt_seq_len,
        d_model=d_model, N=N, h=h, num_landmarks=num_landmarks
    )
